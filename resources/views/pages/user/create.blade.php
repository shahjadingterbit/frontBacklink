<x-base-layout>
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div id="group_details" class="collapse show">
            <!--begin::Form-->
            <form id="kt_account_profile_details_form" class="form" method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data">
                @csrf
                @method('POST')
                <!--begin::Card body-->
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <select name="role" aria-label="{{ __('Select a Role') }}" data-control="select2" data-placeholder="{{ __('Select a role') }}" class="form-select form-select-solid form-select-lg">
                                ...
                                <option data-kt-flag="{{ $value['name'] }}" value="{{ $value['id'] }}">{{ $value['name'] }}</option>
                                @endforeach
                            </select>
                        </div>
                        <!--end::Col-->
