                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-3 dataTable no-footer" id="kt_table_widget_4_table">
                            ...
                            <tbody class="fw-bold text-gray-600">
                                ...
                                <tr class="odd">
                                    ...
                                    <td class="text-end">
                                        <a class="badge py-3 px-4 fs-7 badge-light-warning" href="{{ route('groups.edit', $row['id']) }}">Edit</a>
                                        <a class="badge py-3 px-4 fs-7 badge-light-warning" href="{{ route('groups.destroy',$row['id'])}} ">Delete</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
