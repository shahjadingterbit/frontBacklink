...
<div {{ theme()->printHtmlAttributes("page-title") }} class="d-flex {{ $baseClass }}">
    ...
    <div class="clearfix googleDomainSearchBar">
        {{ theme()->getView('layout/search/_base',array('domainName' => $domainName,'searchMainTypeID' => $searchMainTypeID,'searchInputID' => $searchInputID,'searchPlaceholder' => $searchPlaceholder)) }}
    </div>
    @endif
    <!--end::Title-->
