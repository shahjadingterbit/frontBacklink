...
var KTLayoutSearchData = (function () {
        ...
        var timeout = setTimeout(function () {
            ...
            $(".gooleDomainList").each(function () {
                if (
                    ...
                    $(this)
                        .parents(".domainConsoleParentDiv")
                        .attr("style", "display: none !important");
                } else {
                    $(this).parents(".domainConsoleParentDiv").removeAttr("style");
                    count++;
                }
            });
            search.complete();
    ...
    var clear = function (search) {
        ...
        $(".domainConsoleParentDiv").removeAttr("style");
    ...
    return {
        init: function () {
            // Elements
            element = document.querySelector("#kt_console_search");
