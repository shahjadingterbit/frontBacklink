                        ...
                        <div class="card-body pt-2">
                            ...
                            <div class="d-flex align-items-center mb-8">
                                ...
                                <div class="form-check form-check-custom form-check-solid mx-5">
                                    <input class="form-check-input" type="checkbox" name="group[]" value="<?php echo e($row['id']); ?>" <?php if(in_array($row['id'],$assignedGroupIds)): ?> checked <?php endif; ?>>
                                </div>
                                <!--end::Checkbox-->
                                <!--begin::Description-->
                                ...
                                <!--end::Description-->
                                <?php if(in_array($row['id'],$assignedGroupIds)): ?>
