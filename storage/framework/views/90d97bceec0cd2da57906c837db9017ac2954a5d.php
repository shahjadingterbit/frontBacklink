    ...
    <div class="card w-100 rounded-0 border-0" id="kt_drawer_chat_messenger">
        ...
        <div class="card-header pe-5" id="kt_drawer_chat_messenger_header">
            ...
            <div class="card-toolbar">
                ...
                <div class="me-2">
                    ...
                    <?php echo e(theme()->getView('pages/apps/chat/_partials/__primary-menu')); ?>
                ...
                <div class="btn btn-sm btn-icon btn-active-light-primary" id="kt_drawer_chat_close">
                    <?php echo theme()->getSvgIcon("icons/duotune/arrows/arr061.svg", "svg-icon-2"); ?>
        ...
        <div class="card-body" id="kt_drawer_chat_messenger_body">
            ...
            <div
                ...
                <?php echo e(theme()->getView('pages/apps/chat/_partials/__messages')); ?>
...
<!--end::Chat drawer-->
<?php /**PATH C:\xampp\htdocs\project-backlink\resources\views/pages/apps/chat/_partials/_drawer-messenger.blade.php ENDPATH**/ ?>