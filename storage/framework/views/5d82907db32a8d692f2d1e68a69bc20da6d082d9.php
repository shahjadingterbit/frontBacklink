        ...
        <div class="d-flex flex-column align-items-<?php echo e($message['type'] === 'in'? 'start' : 'end'); ?>">
            ...
            <div class="d-flex align-items-center mb-2">
                <?php if($message['type'] === 'in'): ?>
                    ...
                    <!--begin::Details-->
                    <div class="ms-3">
                        <a href="#" class="fs-5 fw-bolder text-gray-900 text-hover-primary me-1"><?php echo e($user['name']); ?></a>
            ...
            <!--begin::Text-->
            <div class="p-5 rounded bg-light-<?php echo e($state); ?> text-dark fw-bold mw-lg-400px text-<?php echo e($message['type'] === 'in'? 'start' : 'end'); ?>" data-kt-element="message-text">
...
<?php /**PATH C:\xampp\htdocs\project-backlink\resources\views/pages/apps/chat/_partials/__messages.blade.php ENDPATH**/ ?>