...
<div class="card mb-5 mb-xl-10">
    ...
    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#group_details" aria-expanded="true" aria-controls="group_details">
        ...
        <div class="card-title m-0">
            <h3 class="fw-bolder m-0"><?php echo e(__('Edit')); ?> <?php echo e($groupData['group_name']); ?></h3>
        </div>
        <!--end::Card title-->
    </div>
    <!--begin::Card header-->
    ...
    <div id="group_details" class="collapse show">
        <!--begin::Form-->
        <form id="group_details_form" class="form" method="POST" action="<?php echo e(route('groups.update', $groupData['id'])); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <!--begin::Card body-->
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 fv-row">
                                <input type="text" name="name" id="name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Name" value="<?php echo e(old('first_name', $groupData['group_name'] ?? '')); ?>"/>
                                <input type="hidden" name="group_id" id="group_id" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Name" value="<?php echo e(old('first_name', $groupData['id'] ?? '')); ?>"/>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Row-->
            ...
            <div class="card-footer d-flex justify-content-end py-6 px-9">
                ...
                <button type="submit" class="btn btn-primary" id="group_details_submit">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\project-backlink\resources\views/pages/group/edit_group.blade.php ENDPATH**/ ?>