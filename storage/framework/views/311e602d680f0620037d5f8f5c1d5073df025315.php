    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#group_details" aria-expanded="true" aria-controls="group_details">
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0"><?php echo e(__('Edit')); ?> <?php echo e($userData['name']); ?></h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div id="group_details" class="collapse show">
            <!--begin::Form-->
            <form id="kt_account_profile_details_form" class="form" method="POST" action="<?php echo e(route('users.update', $userData['id'])); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="card-body border-top p-9">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 fv-row">
                                    <input type="text" name="name" id="name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Name" value="<?php echo e(old('first_name', $userData['name'] ?? '')); ?>" />
                                    <input type="hidden" name="user_id" id="user_id" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Name" value="<?php echo e(old('first_name', $userData['id'] ?? '')); ?>" />
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Row-->
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <!--begin::Col-->
                                <div class="col-lg-12 fv-row">
                                    <input type="text" name="email" id="email" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Email" value="<?php echo e(old('first_name', $userData['email'] ?? '')); ?>" />
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Row-->
                    ...
                    <div class="row mb-6">
                        <!--begin::Label-->
                        <label class="col-lg-4 col-form-label fw-bold fs-6"><?php echo e(__('Password')); ?></label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8">
                            <!--begin::Row-->
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <select name="role" aria-label="<?php echo e(__('Select a Role')); ?>" data-control="select2" data-placeholder="<?php echo e(__('Select a role')); ?>" class="form-select form-select-solid form-select-lg">
                                ...
                                <option data-kt-flag="<?php echo e($value['name']); ?>" value="<?php echo e($value['id']); ?>" <?php echo e($value['id'] === old('currency', $userData['role_id'] ?? '') ? 'selected' :''); ?>><?php echo e($value['name']); ?></option>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\project-backlink\resources\views/pages/user/edit_user.blade.php ENDPATH**/ ?>