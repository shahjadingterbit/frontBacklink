...
<?php $component->withAttributes([]); ?>
    <?php echo e(theme()->getView('pages/account/_navbar', array('class' => 'mb-5 mb-xl-10'))); ?>

    <?php echo e(theme()->getView('pages/account/overview/_details', array('class' => 'mb-5 mb-xl-10', 'info' => auth()->user()->info))); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\project-backlink\resources\views/pages/account/overview/overview.blade.php ENDPATH**/ ?>