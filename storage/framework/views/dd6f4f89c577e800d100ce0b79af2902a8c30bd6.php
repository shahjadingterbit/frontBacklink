    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#group_details" aria-expanded="true" aria-controls="group_details">
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0"><?php echo e(__('Add Role')); ?> </h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div id="group_details" class="collapse show">
            <!--begin::Form-->
            <form id="role_details_form" class="form" method="POST" action="<?php echo e(route('roles.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <!--begin::Card body-->
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\project-backlink\resources\views/pages/role/create.blade.php ENDPATH**/ ?>