    ...
    <div class="card">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0"><?php echo e(__('Create Group')); ?></h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div id="kt_account_profile_details" class="collapse show">
            <!--begin::Form-->
            <form id="group_details_form" class="form" method="POST" action="<?php echo e(route('groups.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <!--begin::Card body-->
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\project-backlink\resources\views/pages/group/create.blade.php ENDPATH**/ ?>