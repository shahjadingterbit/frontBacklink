...
if (!function_exists('getCustomGroup')) {
    /**
     * Custom Group file
     *
     * @return bool
    ...
    function getCustomGroup() {
       $newArray = [];
       $allGroup = Group::orderBy('name','asc')->get()->toArray();
       $mainArray = array(
            'title'      => 'Groups',
            'path'      => '#',
        ...
        foreach($allGroup as $result) {
            $mainArray['sub']['items'][] = array(
                'title'      =>  ucfirst($result['name']),
                'path'    => 'group/headings?group_id='.$result['id'],
    ...
    function getAllDomains() {
        return Domain::orderBy('id','asc')->get()->toArray();
    }
}