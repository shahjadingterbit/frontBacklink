...
Route::group(['prefix' => '/v1', 'as' => 'api.'], function () {
    Route::get('/listActiveUsers/{propertyId}/{token}', [AnalyticsController::class, 'listActiveUsers']);
    Route::get('/listEvents/{propertyId}/{token}', [AnalyticsController::class, 'listEvents']);
    Route::get('/listScreenPageViews/{propertyId}/{token}', [AnalyticsController::class, 'listScreenPageViews']);
});
